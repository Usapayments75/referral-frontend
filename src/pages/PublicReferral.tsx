...
export default function PublicReferral() {
	...
	const faqs = [
		...
		{
			question: "How much do most merchants save on average?",
			answer: "On average, merchants save between 15–30% on their payment processing fees when they switch to USA Payments."
		},
		{
			question: "Do you support my industry?",
			answer: "Yes! We work with a wide range of industries, including retail, healthcare, hospitality, and e-commerce."
		},
		{
			question: "Will I need to replace my current equipment?",
			answer: "Not necessarily. We integrate with most existing systems and offer free equipment if needed."
		},
		{
			question: "Is there a long-term commitment required?",
			answer: "No, we offer flexible, no-commitment agreements tailored to your business needs."
		},
		{
			question: "What kind of support does USA Payments offer?",
			answer: "Our team is available 24/7 to assist you with any issues or questions."
		},
		{
			question: "How do I know if USA Payments is the right fit for my business?",
			answer: "Request a free payment analysis today, and we'll show you how much you can save and how easy it is to switch."
		},
		{
			question: "What is the process to get started?",
			answer: "It's simple! Fill out the form above and one of our payment experts will contact you to discuss your needs and provide a detailed savings analysis."
		}
	];
